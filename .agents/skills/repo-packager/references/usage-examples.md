...
- Si se solicitan más de 10, tratar cualquier recorte de la implementación
  actual como `PARTIAL`; no continuar como si el pack fuera completo.
...
La skill canónica vive en `FitFlow/.agents/skills/repo-packager/` porque el
Project Profile y las instrucciones permanecen junto al producto. OpenCode la
consume mediante el adapter; FitFlow-ai no mantiene una copia editable.
