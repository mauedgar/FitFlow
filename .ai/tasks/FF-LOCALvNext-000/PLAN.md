...
1. Curar las 10 tareas locales (FF-LOCAL-001 a FF-LOCAL-010) usando **solo** evidencia primaria: código, tests, migraciones, configuración y `RESULT.md` por tarea.
2. Producir un veredicto único por tarea y un veredicto global de baseline.
...
| 2    | Inventariar 10 tareas FF-LOCAL-001..010 con `RESULT.md` existente                                                                  | Agente             | Tabla: Task                                                      |
